...
from rest_framework.status import (
    HTTP_400_BAD_REQUEST, HTTP_405_METHOD_NOT_ALLOWED
)
...
from .permissions import (
    IsAdminOrMe, IsAdminOrReadOnly, IsAuthenticatedOrReadOnly,
...
EMAIL_TEXT = (
    'You secret code for getting the token: {confirmation_code}\n'
